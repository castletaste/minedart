...
- IDs 1–21 and MDRT1 reading are compatibility contracts. MDRT1 migrates in memory; `save/world_saver.dart` is legacy-import only.
- Format, metadata, dimensions, ordering, raw layout, or legacy-id changes require a new version and migration design.
...
Test codec failures/migration, repository operations/collisions, autosave races, and defensive copies. Only restart/reload proves native/browser persistence end to end; state the tested layer.
