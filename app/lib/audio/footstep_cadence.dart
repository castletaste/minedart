...
final class FootstepCadence {
  FootstepCadence({
    this.walkStrideBlocks = classicStrideBlocks,
    this.sprintStrideBlocks = defaultSprintStrideBlocks,
  }) : assert(walkStrideBlocks > 0 && walkStrideBlocks.isFinite),
       assert(sprintStrideBlocks > 0 && sprintStrideBlocks.isFinite);

  static const double classicStrideBlocks = 5 / 3;
  static const double defaultSprintStrideBlocks = 1.5;

  final double walkStrideBlocks;
  final double sprintStrideBlocks;
  ...
  bool update({
    ...
    final strideBlocks = sprinting ? sprintStrideBlocks : walkStrideBlocks;
