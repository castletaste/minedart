  ...
  group('debug overlay state', () {
    ...
    test('formats the exact throttled performance F3 readout', () {
      ...
      expect(
        ...
        'movement: sprint\n'
        'wall frame n 3  p50 16.0  p95 18.3  p99 22.5 ms\n'
        'update n 3  p50 2.0  p95 3.0  p99 4.0 ms\n'
        'cpu render n 3  p50 6.5  p95 7.8  p99 8.0 ms\n'
        'cpu mesh drain n 2  p50 0.5  p95 1.3  p99 1.3 ms\n'
