...
/// Bridges macOS unbounded relative mouse movement to Flutter.
///
/// Disassociating the cursor freezes it while local NSEvents continue to
/// report deltaX/deltaY. Every exit path restores the cursor association.
