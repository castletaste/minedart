...
void main() {
  ...
  final provenance = <String, Object?>{
    ...
    'legacyFallback': <String, Object?>{
      ...
      'status': 'immutable and not generated by this pipeline',
    },
    ...
    'output': <String, Object?>{
      ...
      'unusedTiles': '36..255 transparent RGBA(0,0,0,0)',
    },
...
void _validateMasterSet(Map<int, _MasterBuild> masters) {
  ...
  if (!_listEquals(indices, expected)) {
    throw StateError('Master indices must be exactly 0..35, got $indices.');
  }
